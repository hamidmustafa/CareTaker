...
public class PasswordRecovery_Patient extends AppCompatActivity {

    private static EditText RegisteredEmail_Text;
    private Button Registered_Email_Button;
    private ProgressDialog progressDialog;
    private static String URL_Registration = "http://www.mspstracker.com/caretaker/passwordrecovery_patient.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_password_recovery__patient);
        ...
        Registered_Email_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(PasswordRecovery_Patient.this, "Field can not be empty", Toast.LENGTH_SHORT).show();
                }
