...
public class ChangePassword_Patient extends AppCompatActivity {
    ...
    public static String URL_Registration = "http://www.mspstracker.com/caretaker/update_password_patient.php";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_change_password__patient);
