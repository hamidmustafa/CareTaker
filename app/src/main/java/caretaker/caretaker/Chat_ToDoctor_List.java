...
public class Chat_ToDoctor_List extends AppCompatActivity implements ListAdapter_ForChat.customButtonListener {
    private ListView ListView_Appointments;
    ListAdapter_ForChat adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat__to_doctor__list);
       ...
       ArrayList_Combine_=new ArrayList<String>();
        ListView_Appointments = (ListView) findViewById(R.id.listView_chats);
        getDoctorList();
    ...
    public void onButtonClickListner(int position, String value) {
        ...
        Intent intent=new Intent(Chat_ToDoctor_List.this, ChatScreen.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new ListAdapter_ForChat(Chat_ToDoctor_List.this, ArrayList_Combine_);
                    adapter.setCustomButtonListner(Chat_ToDoctor_List.this);
